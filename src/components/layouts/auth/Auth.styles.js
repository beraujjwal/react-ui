...
import { AppInput as CommonInput } from '../../common/inputs/input/AppInput';
import { AppPassword as CommonAppPassword } from '../../common/inputs/password/AppPassword';
...
import { AppCheckbox } from '../../common/checkboxs/AppCheckbox';
...
export const FormCheckbox = styled(AppCheckbox)`
  display: flex;
...
export const FormInputPassword = styled(CommonAppPassword)`
  color: var(--text-main-color);
  background: transparent;
